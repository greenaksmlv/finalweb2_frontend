<template>
  ...
  sm:px-6 lg:px-8 bg-no-repeat bg-cover" style="background-image:
  url('https://foodrevolution.org/wp-content/uploads/2019/01/iStock-855098134-marilyna-featured.jpg');
  background-size: cover; background-position: center;" >
    <div class="max-w-md w-full space-y-8 text-gray-700 bg-white p-4 rounded-xl">
      <!-- Logo and title -->
      <div class="flex items-center justify-center">
        ...
        <!-- Title text -->
        <h2 class="text-4xl font-bold p-4">
          Meal <br />
          Marvel
        </h2>
      </div>
      ...
      <form class="mt-8 space-y-6" @submit.prevent="onSubmit">
        ...
        <div class="rounded-md shadow-sm -space-y-px">
          ...
          <div>
            ...
            <input
              ...
              v-model="password"
              required
              class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-orange-500 focus:border-500 focus:z-10 sm:text-sm"
        ...
        <div>
          <button
            type="submit"
            class="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-orange-600 hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
          >
            Login
          </button>
        </div>
